...
% 该.m文件是对基于FFT的相关捕获算法version1的完善版本，主要修改的地方有：
% 1. 使用SampleMatchCode函数将采样后的数据整合为长度为2046的离散信号
% 2. 使用SetThreshold函数设置判决门限，而不是人为设定
% 捕获结果为：卫星编号存储在result变量中，相位存储在phase变量中
