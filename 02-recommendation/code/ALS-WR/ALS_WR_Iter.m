function [trainMSE,testMSE] = ALS_WR_Iter(traindata,testdata,M,d,lambda,Iterations)
% 使用ALS_WR算法计算U和V
...
trainMSE = zeros(1,Iterations);
testMSE = zeros(1,Iterations);
...
for iter = 1:Iterations
    ...
    Rals = U*V';
    [trainMSE(iter),testMSE(iter)] = calcMSE(traindata,testdata,Rals);
end
% 迭代结束，得到矩阵U和V
